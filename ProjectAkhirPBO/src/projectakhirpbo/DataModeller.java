...
public class DataModeller {
    ...
    public DataModeller(String driver) throws SQLException {
    ...
    public ObservableList<Individu> getIndividu(){
        ...
        try {
            ...
            Logger.getLogger(DataModeller.class.getName()).log(Level.SEVERE, null, ex);
        }     
        return data;
    }
