...
public class Perusahaan extends Nasabah{
    ...
    public Perusahaan(String nib, Integer nasabahID, String nama, String alamat, ArrayList<Rekening> rekenings) {
        super(nasabahID, nama, alamat, rekenings);
        this.nib = new SimpleStringProperty(nib);
    }
    
    public Perusahaan(String nib, Integer nasabahID, String nama, String alamat, Rekening rekening) {
