...
public class Individu extends Nasabah{
    ...
    public Individu(String nik, String npwp, Integer nasabahID, String nama, String alamat, ArrayList<Rekening> rekenings) {
        super(nasabahID, nama, alamat, rekenings);
        this.nik = new SimpleStringProperty(nik);
        this.npwp = new SimpleStringProperty(npwp);
    }
    
    public Individu(String nik, String npwp, Integer nasabahID, String nama, String alamat, Rekening rekening) {
